...
<p align="center">
  ...
  </a><a href="https://www.linkedin.com/in/sandrofernandesrosal/">
...
Sou um desenvolvedor apaixonado por tecnologia, com foco em **aplicações web modernas**, atuando desde a **criação de interfaces responsivas** até a **lógica de negócio**, **estruturação de dados** e **integrações com APIs**.

Formado em **Análise e Desenvolvimento de Sistemas**, utilizo **Git/GitHub** para versionamento e aplico **metodologias ágeis como Scrum e Kanban** para organizar e acompanhar demandas de forma eficiente no dia a dia.
...
🔹 **apg-frontend**  
Frontend do projeto **APG (Igreja)**, desenvolvido de forma **voluntária**, utilizando **Next.js + TypeScript**.

🔹 **apg-backend**  
Backend do projeto **APG (Igreja)**, desenvolvido de forma **voluntária**, utilizando **Node.js + TypeScript + PostgreSQL**.
